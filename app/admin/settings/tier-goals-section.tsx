...
export default async function TierGoalsSection() {
    ...
    return (
        <div className="rounded-2xl border p-5 space-y-3">
            <div>
                <h2 className="text-lg font-semibold">Weekly Point Goals by Tier</h2>
                <p className="text-sm text-muted-foreground">
                    Set target weekly points for each tier. Teams will see their progress toward their tier's goal.
                </p>
            </div>
